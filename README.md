...
The canonical git repository is located at https://git.bendaws.net/py4dummies/py4dummies, with a mirror avaliable at https://github.com/py4dummies/py4dummies.
